...
// Exported operations.
	 ...
	 * <P>
	 * The class loader in which to find the given class must also be specified.
	 * In general, this should be the class loader that loaded the class that
	 * contains the code that is calling <TT>newInstance()</TT>.
	 *
	...
	public static Object newInstance
		...
		if (j == -1)
			...
			throw new IllegalArgumentException
				("Instance.newInstance(\""+s+"\"): Missing '('");
			}
		if (i == j)
			{
			throw new IllegalArgumentException
				("Instance.newInstance(\""+s+"\"): Missing class name");
			}
