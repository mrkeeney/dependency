...
public class OpenMMLibrary implements Library {
	...
	public static native void OpenMM_Context_reinitialize(PointerByReference target);
	/**
	 ...
	 */
	public static native PointerByReference OpenMM_LocalCoordinatesSite_create(int particle1, int particle2, int particle3, OpenMM_Vec3 originWeights, OpenMM_Vec3 xWeights, OpenMM_Vec3 yWeights, OpenMM_Vec3 localPosition);
	...
	public static native OpenMM_Vec3 OpenMM_LocalCoordinatesSite_getOriginWeights(PointerByReference target);
	/** Original signature : <code>OpenMM_Vec3* OpenMM_LocalCoordinatesSite_getXWeights(const OpenMM_LocalCoordinatesSite*)</code> */
	public static native OpenMM_Vec3 OpenMM_LocalCoordinatesSite_getXWeights(PointerByReference target);
	/** Original signature : <code>OpenMM_Vec3* OpenMM_LocalCoordinatesSite_getYWeights(const OpenMM_LocalCoordinatesSite*)</code> */
	public static native OpenMM_Vec3 OpenMM_LocalCoordinatesSite_getYWeights(PointerByReference target);
