/* Swig input file,
   generated by /Data/ffx-project/other/openmm-amoeba-build/python/src/swig_doxygen/swigInputBuilder.py on Sun Apr 30 10:13:43 2017
*/
...
%copyctor AmoebaAngleTorsionForce ;
class AmoebaAngleTorsionForce ;
...
%copyctor AmoebaStretchTorsionForce ;
class AmoebaStretchTorsionForce ;
...
class AmoebaAngleTorsionForce : public Force {
public:
   AmoebaAngleTorsionForce() ;

   int getNumAngleTorsions() const ;
   int addAngleTorsion(int particle1, int particle2, int particle3, int particle4, double angleCBA, double angleDCB, double k1, double k2, double k3, double k4, double k5, double k6) ;
   %apply int & OUTPUT { int & particle1 };
   %apply int & OUTPUT { int & particle2 };
   %apply int & OUTPUT { int & particle3 };
   %apply int & OUTPUT { int & particle4 };
   %apply double & OUTPUT { double & angleCBA };
   %apply double & OUTPUT { double & angleDCB };
   %apply double & OUTPUT { double & k1 };
   %apply double & OUTPUT { double & k2 };
   %apply double & OUTPUT { double & k3 };
   %apply double & OUTPUT { double & k4 };
   %apply double & OUTPUT { double & k5 };
   %apply double & OUTPUT { double & k6 };
   void getAngleTorsionParameters(int index, int &particle1, int &particle2, int &particle3, int &particle4, double &angleCBA, double &angleDCB, double &k1, double &k2, double &k3, double &k4, double &k5, double &k6) const ;
   %clear int & particle1;
   %clear int & particle2;
   %clear int & particle3;
   %clear int & particle4;
   %clear double & angleCBA;
   %clear double & angleDCB;
   %clear double & k1;
   %clear double & k2;
   %clear double & k3;
   %clear double & k4;
   %clear double & k5;
   %clear double & k6;
   void setAngleTorsionParameters(int index, int particle1, int particle2, int particle3, int particle4, double angleCBA, double angleDCB, double k1, double k2, double k3, double k4, double k5, double k6) ;
   %apply Context & OUTPUT { Context & context };
   void updateParametersInContext(Context &context) ;
   %clear Context & context;
   virtual bool usesPeriodicBoundaryConditions() const ;
...
class AmoebaStretchTorsionForce : public Force {
public:
   AmoebaStretchTorsionForce() ;

   int getNumStretchTorsions() const ;
   int addStretchTorsion(int particle1, int particle2, int particle3, int particle4, double lengthBA, double lengthCB, double lengthDC, double k1, double k2, double k3, double k4, double k5, double k6, double k7, double k8, double k9) ;
   %apply int & OUTPUT { int & particle1 };
   %apply int & OUTPUT { int & particle2 };
   %apply int & OUTPUT { int & particle3 };
   %apply int & OUTPUT { int & particle4 };
   %apply double & OUTPUT { double & lengthBA };
   %apply double & OUTPUT { double & lengthCB };
   %apply double & OUTPUT { double & lengthDC };
   %apply double & OUTPUT { double & k1 };
   %apply double & OUTPUT { double & k2 };
   %apply double & OUTPUT { double & k3 };
   %apply double & OUTPUT { double & k4 };
   %apply double & OUTPUT { double & k5 };
   %apply double & OUTPUT { double & k6 };
   %apply double & OUTPUT { double & k7 };
   %apply double & OUTPUT { double & k8 };
   %apply double & OUTPUT { double & k9 };
   void getStretchTorsionParameters(int index, int &particle1, int &particle2, int &particle3, int &particle4, double &lengthBA, double &lengthCB, double &lengthDC, double &k1, double &k2, double &k3, double &k4, double &k5, double &k6, double &k7, double &k8, double &k9) const ;
   %clear int & particle1;
   %clear int & particle2;
   %clear int & particle3;
   %clear int & particle4;
   %clear double & lengthBA;
   %clear double & lengthCB;
   %clear double & lengthDC;
   %clear double & k1;
   %clear double & k2;
   %clear double & k3;
   %clear double & k4;
   ...
   %clear double & k8;
   %clear double & k9;
   void setStretchTorsionParameters(int index, int particle1, int particle2, int particle3, int particle4, double lengthBA, double lengthCB, double lengthDC, double k1, double k2, double k3, double k4, double k5, double k6, double k7, double k8, double k9) ;
   %apply Context & OUTPUT { Context & context };
   void updateParametersInContext(Context &context) ;
   %clear Context & context;
   virtual bool usesPeriodicBoundaryConditions() const ;
...
public:
   ...
   %apply double & OUTPUT { double & combinedSigma };
   %apply double & OUTPUT { double & combinedEpsilon };
   void getVdwprParameters(int ntype1, int ntype2, double &combinedSigma, double &combinedEpsilon) const ;
   %clear double & combinedSigma;
   %clear double & combinedEpsilon;
